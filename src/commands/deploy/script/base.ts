...
/**
 * The upgrade context will be automatically substituted
 */
export type TUpgradeContext<T, A> = {
    deployedContracts: T,
    metadata: A
}
...
> {
     ...
     */
    abstract execute(walletClient: WalletClient<TTransport, TNetwork, TAccount, TRPCSchema>, context: TUpgradeContext<TUCContext, TUCMeta>): Promise<void>;
}